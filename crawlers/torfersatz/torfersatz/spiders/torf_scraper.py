...
class TorfScraperSpider(scrapy.Spider):
    name = "torf_scraper"
    allowed_domains = ["torfersatz.fnr.de"]
    start_urls = ["https://torfersatz.fnr.de/foerderung/projektdatenbank"]
    quotechar = "'"
    ...
    def sub_parse(self, response):
        ...
        yield {
            ...
            "program": "Torfminderung und Moorbodenschutz",# [Program Name, wenn Projekt]
